...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO clientes (nombre_clientes, dni_cuit_clientes, email_clientes, telefono_clientes, direccion_clientes, localidad_clientes, tipo_cliente_clientes, observaciones_clientes) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    
    $stmt = $conexion->prepare($sql);
    $stmt->bind_param("ssssssss", $nombre, $dni_cuit, $email, $telefono, $direccion, $localidad, $tipo_cliente, $observaciones);
